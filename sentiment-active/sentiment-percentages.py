...
def process_all_csv_files(folder_path):
    ...
    average_percentages = percentages_df[['positive', 'neutral', 'negative']].mean().to_dict()
    average_percentages['total_comments'] = percentages_df['total_comments'].sum()
    average_percentages['filename'] = 'Average'
