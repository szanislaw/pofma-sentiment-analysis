...
file_path = 'model/cleaned master dataset.xlsx'  # Update this with your file path
...
model.save_pretrained('models/pofma_model')
tokenizer.save_pretrained('models/pofma_tokenizer')
...
# Define the folder where you want to save the graph
...
# Save the plot to the 'model-graph' directory with the date and time in the filename
