...
# Set path to your user data directory and profile
chrome_user_data_dir = r"C:\Users\<Your-Username>\AppData\Local\Google\Chrome\User Data"  # Adjust this path as necessary
chrome_profile = "Default"  # Specify the profile you want to use, e.g., 'Default' or 'Profile 1'
...
def get_facebook_comments(url):
    driver.get(url)  # Automatically load the specified Facebook page
...
# Load the Facebook page and get comments
