...
optimizer = AdamW(model.parameters(), lr=1e-5, weight_decay=0.01)  # Experiment with 3e-5 as well
...
for epoch in range(epochs):
    ...
    # Gradient CLipping
    train_loss = train_epoch(model, train_loader, optimizer, device, max_grad_norm=0.5)
